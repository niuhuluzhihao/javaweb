    ...
    <table class="tab" cellspacing="0px">
      <tr class="ltr">
        ...
        <td>
          ...
          v-model="registUser.username" blur="checkUsername()">
      ...
      <tr class="ltr">
        ...
        <td>
          ...
          v-model="registUser.userPwd" blur="checkUserPwd()">
      ...
      <tr class="ltr">
        ...
        <td>
          ...
          v-model="reUserPwd" blur="check4eUserPwd()">
